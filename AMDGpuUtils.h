...
//=============================================================================
// AMD ROCm best practice: Use portable C++ instead of inline assembly
...
//=============================================================================
	...
	// AMD ROCm/HIP: Use portable C++ implementation
	#include "AMDGpuUtils_AMD.h"
#else
	// NVIDIA CUDA: Use PTX inline assembly
	//PTX asm
